...
- [x] A fresh-page offline reload of the bundled Cyrillic path passes in Chromium and Firefox after service-worker warm-up; WebKit skips this browser-wide offline reload because of its internal local File/Blob limitation. CDN-delivered models remain dependent on their browser-side Tesseract cache/IndexedDB entry and are not claimed fresh-page offline
