...
- [/] The T32 route now downloads only on user action, reports progress, supports cancellation and optional per-model URL fallback, validates size/SHA-256, caches in IndexedDB, probes browser inference, and keeps Tier 1 available. Real degraded-photo quality, production-origin longevity, warm-cache/offline E2E, and full route STCC remain open; do not infer a general restoration benefit from the synthetic comparisons
