...
- [/] Engine primitives or adapters and dedicated product routes cover T27 Smart Crop, T32 Upscale, T57 manual region blur, T60 Compare, T61 Duplicates, T62 OCR, T63 manual alt-text review, T70 Pixel-Art Upscale, T79 Procedural Generator, T80 Colour Match, and T81 Adaptive Resize; their route-level STCC remains incomplete. T32's DCCI/NEDI `/upscale` route runs in a local worker, accepts bounded still PNGs, and passed a focused fresh-preview Chromium suite 9/9 plus a separate active-source-replacement regression 1/1. Tier 2 now has a user-started, size-disclosed download with progress, cancellation, size/SHA-256 verification, IndexedDB reuse, an inference probe, and Tier 1 recovery. The ~64 MiB model files stay outside Git and the Docker image. T32 output-byte limits were rejected in E2E across Chromium, Firefox, and WebKit; successful Tier 2 route E2E, warm-cache/offline behavior, production deployment availability, browser performance budgets, real-camera quality, and full STCC remain open. T60's focused Chromium route E2E passed 8/8; its ≤256-pixel score proxy, route latency, hard comparisons, representative comparison quality, and full STCC remain open. T70's 16-case route suite passed Chromium and installed Edge; Firefox and WebKit passed all 15 functional cases and skipped only the Chromium/Edge-only latency measurement. Its 320 CSS-pixel layout passed without horizontal overflow in all four browsers; actual 400% browser zoom remains unverified. T27 now has a reproducible 12-case route-aligned crop benchmark on four CC0 images: mean subjective target-box retention is 89.82% center, 76.70% thirds, and 71.97% approximate saliency. The boxes do not assess visual quality or preference. T57 is manual-region-only; face detection and batch operation are not implemented. T63 is a manual alt-text writing aid, not an automated accessibility audit. T61 reuses shared analysis primitives. All eleven STCC rows remain open.
