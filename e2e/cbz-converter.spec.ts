...
const onePageCbz = Buffer.from(
  'UEsDBBQAAAAAAAAAIQAvZp0vRgAAAEYAAAAJAAAAcGFnZTEucG5niVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQI12P4z8DwHwAFAAH/iZk9HQAAAABJRU5ErkJgglBLAQIUABQAAAAAAAAAIQAvZp0vRgAAAEYAAAAJAAAAAAAAAAAAAAAAAAAAAABwYWdlMS5wbmdQSwUGAAAAAAEAAQA3AAAAbQAAAAAA',
  'base64',
);
