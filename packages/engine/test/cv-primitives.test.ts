...
describe('P4-01 CV primitives', () => {
  ...
  it('canny detects edges', () => {
    const image = createRaster(
      ...
      5,
      new Uint8ClampedArray([
        0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 0, 0, 0,
        255, 255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255,
        255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 255,
        255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0,
  ...
  it('sobel produces gradient magnitude mask', () => {
    const image = createRaster(
      ...
      3,
      new Uint8ClampedArray([
        0, 0, 0, 255, 0, 255, 255, 255, 0, 255, 255, 255, 255, 0, 255, 255, 255, 255, 255, 255, 255,
        255, 255, 255, 0, 255, 255, 255, 255, 255, 0, 255, 255, 255, 255, 255,
      ]),
    );
  ...
  it('hough detects lines from simple pattern', () => {
    const image = createRaster(
      ...
      new Uint8ClampedArray([
        ...
        255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255,
        255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255,
        255, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255,
  ...
  it('morphology erode and dilate produce masks', () => {
    const image = createRaster(
      ...
      new Uint8ClampedArray([
        ...
        255, 255, 255, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 0, 255, 255, 255,
      ]),
    );
