...
magic are exercised through the typed error boundary for BMP, CUR, DDS, FITS, Radiance HDR, ICO, PCX,
PFM, PNM/PAM, QOI, SGI, Sun Raster, TGA, WBMP, XBM, and XPM. The remaining cases include
